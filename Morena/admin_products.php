...
if(isset($_POST['add_product'])){
   ...
   if(mysqli_num_rows($select_product_name) > 0){
      ...
      $insert_product = mysqli_query($conn, "INSERT INTO `products`(name, details, cake_type, price, image) VALUES('$name', '$details', '$cake_type', '$price', '$image')") or die('query failed');
...
<head>
   ...
   <title>Morena's Cosmetic Shop - Admin | Products</title>
	<!-- icon -->
...
<section class="add-products">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
	  ...
	  <select class="box" name="cake_type" required>
                  ...
                  <option value="Cosmetics Tools">Cosmetics Tools</option>								
       </select>
